"""
Django settings for gigasite project.
...
WSGI_APPLICATION = 'gigasite.wsgi.application'
...
DATABASES = {
    'default': dj_database_url.config(default=os.getenv('DATABASE_URL', 'postgres://user:password@db:5432/test_db'), conn_max_age=600, ssl_require=False)
}
